...
import ArrowUpRight from './arrow_up_right.svg';
...
import calendarGridIcon from './calendar_grid_icon.svg';
...
const reviewStartImg = require('./reviewStartImg.png');
...
const noUserFound = require('./noUserFound.png');
import taskBottomIcon from './taskBottomIcon.svg'
const noTTLockScreen = require('./noTTLockScreen.png');
const noListingOnTTLock = require('./noListingOnTTLock.png');
const noSavedReplies = require('./noSavedReplies.png');
import aiAutoReplyIcon from './aiAutoReplyIcon.svg'
const noAutomationScreen = require('./noAutomationScreen.png');
const noAiAutoReplyIcon = require('./noAiAutoReplyIcon.png');
...
const houseIllustration = require('./houseIllustration.png');
...
const house_outline = require('./house_outline.png');
...
const house_step3 = require('./house_step3.png');
...
const noAccountFound = require('./noAccountFound.png');
...
const noTaskAvailable = require('./noTaskAvailable.png');
const noListingFound = require('./noListingFound.png');
