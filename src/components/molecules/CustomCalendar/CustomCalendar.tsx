...
//   // Logo visibility: White on dark backgrounds, Theme Color on light backgrounds
//   const iconColor = isMid ? themeColor : '#FFFFFF';

//   return (
//     <View style={styles.dayCell}>
//       {/* 1. LIGHT PILL BACKGROUND */}
...
//             <Text style={[
//               styles.priceText, 
//               { color: isActive ? (isMid ? '#7B8D88' : 'rgba(255,255,255,0.85)') : '#7B8D88' } as TextStyle
//             ]}>
