...
export const SERVICE_CONFIG_URLS = {
  ...
  APP: {
    ...
    GET_MANAGE_YOUR_LISTINGS_FETCH: `${authController}/user/listings/{user}`,
    GET_MANAGE_YOUR_LISTINGS_PROPERTIES: `${authController}/user/listings/fetch/{user}`,
    ...
    GET_CHAT_LIST: `${authController}/chat/inbox/realtime`,
    ...
    GET_AUTOMATIONS_TEMPLATE_EVENT_TIMES: `${authController}/chat/automations/event-times`,
    GET_AUTOMATIONS_TEMPLATE_BY_ID: `${authController}/chat/automations/{id}`,
    EDIT_STATUS_AUTOMATIONS_TEMPLATE: `${authController}/chat/automations/{id}/status`,
    GET_CHAT_DETAIL: `${authController}/chat/messages/realtime/{conversation_id}`,
    GET_CHAT_DETAIL_SEMD_MESSAGE: `${authController}/chat/messages/realtime/send`,
    GET_CHAT_BROADCAST_CONFIG: `${authController}/chat/messages/realtime/broadcast-config`,
    ...
    AI_ALLOW_STATUS: `${authController}/chat/ai/rules/allow-status`,
    ...
    ALTERATION_REQUEST_RESPOND: `${authController}/bookings/alteration-request/respond`,
    RATE_YOUR_GUEST: `${authController}/guest/reviews`,
    GET_REVIEW_TAGS: `${authController}/guest/review-tags`,
    ...
    STATES_BY_NAME: `${authController}/states?country_name={country_name}`,
    CITIES_BY_NAME: `${authController}/cities?country_name={country_name}&state_name={state_name}`,
    DISTRICTS_BY_NAME: `${authController}/districts?city_name={city_name}`,
    ...
    CHANNEL_STATUS: `${authController}/channelmanagement/channel-status`,
