...
const CreateAutomationTemplateScreen = () => {
  ...
  const showEventTime =
    selectedEvent === 'check_in' || selectedEvent === 'check_out';
      ...
      <View style={styles.container}>
        ...
        >
          ...
          <View style={styles.topTextSection}>
            <AppText
              text={
                isEditMode
                  ? t('app.automation_create_edit.title_edit')
                  : t('app.automation_create_edit.title_create')
              }
              fontSize={28}
              type="Bold"
              color={Colors.BLACK}
            ...
            <AppText
              text={
                isEditMode
                  ? t('app.automation_create_edit.desc_edit')
                  : t('app.automation_create_edit.desc_create')
              }
              fontSize={14}
          ...
          <View style={styles.form}>
            ...
            {showEventTime && (
              <DropdownField
                ...
                placeholder={t(
                  'app.automation_create_edit.event_time_placeholder',
                )}
                dropdownPosition="top"
              />
            )}
        ...
        <View style={styles.footer}>
          <AppButton
            title={
              isEditMode
                ? t('app.automation_create_edit.save_btn')
                : t('app.automation_create_edit.create_btn')
            }
