  ...
  const ModeCard = ({ title, type, points }: any) => {
    ...
    return (
      ...
      >
        ...
        <AppText text="Choose this if:" fontSize={14} mt={10} color="#6B6B6B" />
        ...
        {isActive && (
           <View style={styles.graphContainer}>
              <AppText text="Result:" fontSize={12} color="#6B6B6B" mb={10} />
    ...
    <BGImage source={require('@/assets/img/background/linearBG.png')}>
      <View style={styles.container}>
        <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <AppText text="Select AI Dynamic Pricing" fontSize={32} type="Bold" mt={30} />
          <AppText 
            text="AI Dynamic Pricing adds an intelligent layer on top of automated pricing..." 
          ...
          <View style={styles.overrideRow}>
            <View style={{ flex: 1 }}>
              <AppText text="Manual Price Override" fontSize={18} type="Medium" />
              <AppText text="Turn this on to edit prices for specific dates manually..." fontSize={12} color="#6B6B6B" mt={5} />
            </View>
            <Switch 
