...
const AddBookingCancelPoliciesScreen = () => {
  ...
  const policyOptions = [
    {
      label: 'Flexible - Guests can cancel at least 24 hours before check-in',
      value: 'flexible',
    },
    {
      label: 'Moderate - Guests can cancel at least 5 days before check-in',
      value: 'moderate',
    },
  ...
  const AirbnbOptions = [
    {
      label:
        'Flexible - Full refund at least 1 day before check-in, partial refund within 1 day',
      value: 'flexible',
    },
    {
      label:
        'Moderate - Full refund at least 5 days before check-in, partial refund within 5 days',
      value: 'moderate',
    },
    {
      label:
        'Limited - Full refund at least 14 days before check-in, partial refund 7–14 days before check-in',
      value: 'strict_14_with_grace_period',
    },
    {
      label:
        'Firm - Full refund at least 30 days before check-in, partial refund 7–30 days before check-in',
      value: 'better_strict_with_grace_period',
    },
    {
      label:
        'Super Strict 30 Days - No full refund, partial refund 30+ days before check-in',
      value: 'super_strict_30',
    },
    {
      label:
        'Super Strict 60 Days - No full refund, partial refund 60+ days before check-in',
  ...
  const AirbnblongTermOptions = [
    {
      label:
        'Firm Long Term - Full refund up to 30 days before check-in, after that first 30 days non-refundable',
      value: 'CANCEL_LONG_TERM_FAIR',
    },
    {
      label:
        'Strict Long Term - Full refund within 48 hours of booking (if 28+ days before check-in), after that first 30 days non-refundable',
      ...
      <View style={styles.container}>
        ...
        >
          <AppText
            text={
              isEdit
                ? t('app.booking_cancel_policies.title_edit')
                : t('app.booking_cancel_policies.title_new')
            }
            fontSize={28}
            type="Bold"
            mt={30}
          ...
          <View style={styles.formGroup}>
            <DropdownField
              ...
              data={AirbnbOptions}
              placeholder={t(
                'app.booking_cancel_policies.flexible_placeholder',
              )}
            />
            ...
            <DropdownField
              ...
              control={control as any}
              errors={errors}
              data={AirbnblongTermOptions}
              placeholder={t(
                'app.booking_cancel_policies.longterm_placeholder',
              )}
            />
            <View style={styles.fieldGap} />
            <DropdownField
        ...
        <FormFooterActions
          ...
          primaryTitle={
            isEdit
              ? t('app.booking_cancel_policies.export')
              : t('app.booking_cancel_policies.next')
          }
          onPrimaryPress={isEdit ? handleExport : handleSubmit(onNext)}
          isPrimaryLoading={isLoading}
          isPrimaryDisabled={isLoading}
          // Secondary Action
          secondaryTitle={t('app.booking_cancel_policies.save_exit')}
