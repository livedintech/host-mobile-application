        ...
        >
          ...
          <View style={styles.topTextSection}>
            <AppText
              text={
                isEditMode
                  ? t('app.saved_replies_create_edit.title_edit')
                  : t('app.saved_replies_create_edit.title_create')
              }
              fontSize={28}
              type="Bold"
              color={Colors.BLACK}
            ...
            <AppText
              text={
                isEditMode
                  ? t('app.saved_replies_create_edit.desc_edit')
                  : t('app.saved_replies_create_edit.desc_create')
              }
              fontSize={14}
          ...
          <View style={styles.form}>
            ...
            <TextareaField
              ...
              errors={errors}
              placeholder={t(
                'app.saved_replies_create_edit.content_placeholder',
              )}
              multiline
            />
            ...
            <MultiSelectDropdownField
              ...
              placeholder={t(
                'app.saved_replies_create_edit.property_placeholder',
              )}
          ...
          {/* <View style={styles.footer}>
            <AppButton
              ...
              title={
                isEditMode
                  ? t('app.saved_replies_create_edit.save_btn')
                  : t('app.saved_replies_create_edit.create_btn')
              }
